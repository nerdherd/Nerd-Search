  ...
  return (
    <HashRouter>
      <Routes>
          ...
          <Route path="/formComplete" element={<FormComplete matchInfo={matchInfo} scores={scores} scouterInfo={scouterInfo} scouterComments={scouterComments} resetStates={resetStates}/>}></Route>
